...
- Next-session security handoff: docs/NEXT-SESSION.md. Client/release plan: docs/superpowers/plans/2026-08-19-warden-client-security-hardening.md. It does not change the Phase 1B order; C0 may seed client invariants at a clean boundary, and extension implementation waits for Phase 1B Task 8 to stabilize the client ABI.
