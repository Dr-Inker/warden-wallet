...
> ## 2026-09-01 CLEAN-BREAK PICKUP MEMO — C55 CLOSED; C56 NOT STARTED
>
> `TO / TASK / CWD / BASE / READ / WRITE (edit lease) / DO_NOT_TOUCH / ACCEPT / SIDE_EFFECTS / RETURN`
>
> - **TO:** the next Warden implementation/review session.
> - **TASK:** continue C6 with one bounded C56 contract: when the composed signed-
>   source CLI is given an explicit reviewed-artifact path, require an
>   independently supplied lowercase SHA-256 for that exact artifact-manifest
>   buffer and compare it before canonical parsing, tag verification, or GnuPG.
>   Begin with a fresh read-only grammar/caller map and a real production-CLI RED
>   proving the current explicit-artifact tier accepts no independent artifact
>   identity. Preserve the four-argument local/default source-only tier and every
>   C36/C39–C55 report, signature, store, tag, fingerprint, time/algorithm,
>   stable-reader, path, ceiling, and recipe rule.
> - **CWD:** `/opt/warden`.
> - **BASE:** C55 behavioral RED
>   `7f25504203088eef0ab05a3eab4c18ad81ad3386`; implementation
>   `674b2a7d66499f6544ad6aed954cd35955337515`; ledger-inclusive, fully gated
>   SHA `20c9a0241b475878061b09bb092e0eea82f6e57b`. The documentation-only
>   commit containing this memo is intentionally not described as gate green.
> - **READ:** this memo and the C55/C45/C42 entries; C6 in the client-security
>   plan; composed `verify-release-source-tag.mjs`, every grammar tier/caller and
>   real CLI fixture, the shared source/review verifier, standalone exact-
>   artifact/signature precedent, stable exact-buffer reads, release docs,
>   recipe evidence, and temp cleanup.
> - **WRITE (edit lease):** none is currently claimed. After the read-only map,
>   lease only the composed signed-source CLI, one explicit-artifact exact-
>   digest RED and refusals, its real CLI fixtures/callers, scoped docs/ledger,
>   and recipe-bound evidence strictly changed by the contract.
...
>   sign production bytes, publish, weaken C36/C39–C55 policy, or invent store
>   provenance, freshness, reviewer, builder-independence, key-strength,
>   publisher, or lifecycle policy.
> - **ACCEPT:** executable real-CLI RED proving the explicit reviewed-artifact
>   tier has no independently supplied exact artifact-manifest digest today; an
>   exact lowercase SHA-256 is mandatory beside every explicit artifact path and
>   compared to its one **8 MiB** bounded/stable/path-bound buffer before parsing,
>   tag checks, or GnuPG; wrong/malformed/missing values fail closed; the exact
>   value passes every affected tier; the four-argument local/default tier stays
>   source-only and is named as such; incumbent exact report/signature/store
>   digests, exact primary/signing fingerprints, GnuPG isolation, packet/time/
...
>
> **C55 ledger-inclusive gate:** from a clean tree at
> `20c9a0241b475878061b09bb092e0eea82f6e57b`, this exact command exited **0**
...
> ```
>
> It passed action pins **2/2**, core **700/700**, extension **568/568**, UI
...
> Argon2 elapsed p50/p95 were **936.8/976.4 ms**, host-task delay p50/p95 were
> **61.5/68.4 ms**, and password-buffer wiping was true. The final rehearsal
> compared **14** files and produced a **3,810-byte** canonical report with
> SHA-256
> `a3e5d2eabdf25be98d8782689c0f6cc8f06871c063c937f291be875bf08aabe0`.
> At this ledger SHA the artifact, bundle, recipe, dependency, and static
> sidecar SHA-256 values were respectively
> `93719c2bc94515d87c03ec5298d5104046498db8209312708f922da84e96368b`,
> `b19aaff2628c809ec65df8b775f399a49a53e32e8c3b259024d6ef4ec7d2d717`,
> `3b0c46c98f8c9042196dd06520c4c824a772e922ef0fe7a685942ad319e835f0`,
> `6550d93727be1cad41f87ff1debc52755e51b2fba0477ae29d76aa11bdc29e8e`,
> and `69ecd80a7871585fa93928462bd62664c99867071ed2d4702f38bb349aa89017`;
> the recipe sidecar was **4,740 bytes**, named 23 inputs, and bound the
> standalone detached-review CLI as **3,781 bytes** with SHA-256
...
> remains **UNVERIFIED**.
>
> **Stop state:** C55 is closed. C56 has no code, RED, edit lease, independent
> composed-CLI explicit-artifact digest, real store-returned package, production
...
> `WRD-REL-03` remain `unimplemented`; standalone detached review now pins exact
> artifact and signature bytes, but digest input channels, production trust, and
> the hostile-host boundary remain external.
