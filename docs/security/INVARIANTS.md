...
| `WRD-DEP-01` | **Upgrade authority is the derived Squads vault PDA** — The deployment gate derives the canonical Squads vault PDA from the decoded, owner-checked multisig and requires ProgramData.upgrade_authority_address to equal it (never accepting the authority and the multisig as independent facts), and asserts the multisig threshold and time-lock match spec §5.5 (3-of-5, 7 days). | `unimplemented` | design.md#5.5 | — | — |
