...
| `WRD-EXP-01` | **Fresh ceremony for any secret export** — Any recovery-secret reveal or export requires a fresh ceremony; Warden exposes no export path for root or session secrets and root material never enters extension memory; portable recovery envelopes retain the specified 128-bit secret strength and contextual AAD. (Platform passkey sync is outside this boundary — see WRD-KEY-01 and threat T7.) | `unimplemented` | docs/superpowers/plans/2026-08-19-warden-client-security-hardening.md#C5 | — | — |
