...
# Export this once so commit resolution, worktree creation, diffs, and every later Git probe all
# read the original object graph (WRDF-0158). A clean worktree does not reveal refs/replace/*.
