...
CODEX_ARGS=(exec
  ...
  # shells. Replace the policy at the CLI layer: inherit only Codex's core environment, apply the
  # default secret-name exclusions, clear filters, then inject the one required Git control after
  # exclusions (WRDF-0160; Codex config reference: shell_environment_policy.set).
